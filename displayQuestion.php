	...
	<div class="container">
		...
		<div align="center">
			...
			<br>
				...
				<?php echo "<input type='submit' class='btn btn-primary' id='addComment' name='addComment' value='Post Reply'>"; ?>
				<div id ="errorc"></div>
				<script>
	...
	$(function() {
		$(":submit").click(function() {
			...
			$.post("api.php", JSON.stringify(request), function() {
				if (func == "markResolved" || func == "markUnresolved" || func == "addComment"|| func == "deleteComment") {
					location.reload();
				} else {
